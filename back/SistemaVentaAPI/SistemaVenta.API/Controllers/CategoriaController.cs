...
namespace SistemaVenta.API.Controllers
{
    ...
    public class CategoriaController : ControllerBase
    {
        ...
        {
            var resp = new ResponseApi<List<CategoriaListarDto>>();
            try
            {
        ...
        {
            var resp = new ResponseApi<CategoriaListarDto>();
            try
            {
        ...
        [HttpPost]
        [Route("Crear")]
        public async Task<IActionResult> Crear([FromBody] CategoriaCrearDto modelo)
        {
            var resp = new ResponseApi<CategoriaListarDto>();
            try
            {
        ...
        [HttpPut]
        [Route("Editar")]
        public async Task<IActionResult> Editar([FromBody] CategoriaEditarDto modelo)
        {
