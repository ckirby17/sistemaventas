...
namespace SistemaVenta.API.Controllers
{
    ...
    public class MenuController : ControllerBase
    {
        ...
        {
            var resp = new ResponseApi<List<MenuListarDto>>();
            try
            {
        ...
        {
            var resp = new ResponseApi<MenuListarDto>();
            try
            {
        ...
        [HttpPost]
        [Route("Crear")]
        public async Task<IActionResult> Crear([FromBody] MenuCrearDto modelo)
        {
            var resp = new ResponseApi<MenuListarDto>();
            try
            {
        ...
        [HttpPut]
        [Route("Editar")]
        public async Task<IActionResult> Editar([FromBody] MenuEditarDto modelo)
        {
