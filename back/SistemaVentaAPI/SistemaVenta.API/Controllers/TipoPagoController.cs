...
namespace SistemaVenta.API.Controllers
{
    ...
    public class TipoPagoController : ControllerBase
    {
        ...
        {
            var resp = new ResponseApi<List<TipoPagoListarDto>>();
            try
            {
        ...
        {
            var resp = new ResponseApi<TipoPagoListarDto>();
            try
            {
        ...
        [HttpPost]
        [Route("Crear")]
        public async Task<IActionResult> Crear([FromBody] TipoPagoCrearDto modelo)
        {
            var resp = new ResponseApi<TipoPagoListarDto>();
            try
            {
        ...
        [HttpPut]
        [Route("Editar")]
        public async Task<IActionResult> Editar([FromBody] TipoPagoEditarDto modelo)
        {
